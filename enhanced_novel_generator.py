    ...
    def generate_novel(self, num_chapters):
        ...
        for i, chapter in enumerate(self.world_bible['chapters']):
            ...
            **ИНСТРУКЦИЯ:**
            ...
            и доведении текста до уровня публикуемого оригинального художественного произведения.
            ...
            1. **ИЗБЫТОЧНАЯ ДЕТАЛИЗАЦИЯ:**
               - Удали описания очевидных действий (встал, подошёл, посмотрел, если они не важны)
               - Не описывай каждое движение персонажа
               - Оставь читателю пространство для воображения

            2. **ГИПЕРТРОФИРОВАННАЯ МЕТАФОРИЧНОСТЬ:**
               - Максимум 1–2 метафоры на главу, если они действительно выразительные
            ...
            3. **ЭМОЦИОНАЛЬНАЯ ПЕРЕГРУЖЕННОСТЬ:**
               ...
               - Убери лишние прилагательные вроде "ледяной", "жуткий", "зловещий", если они не добавляют смысла
               - Позволь некоторым моментам быть обыденными, нейтральными
            ...
            4. **НЕЕСТЕСТВЕННЫЕ ДИАЛОГИ:**
               ...
               - Замени реплики, где персонажи "объясняют сюжет", на более живые или эмоциональные
               - Люди часто отвечают не по существу — используй это

            5. **МЕХАНИСТИЧНОСТЬ:**
               - Разнообразь длину предложений
               - Убери шаблонные или одинаково построенные переходы
               - Нарушь идеальную симметрию там, где это естественно
               - Исправь англицизмы в синтаксисе
               - Используй букву "ё", где она обязательна по норме

            6. **РИТМИЧЕСКАЯ ПЛАСТИКА:**
               - Чередуй плотные и лёгкие абзацы
               - Используй короткие, обрывочные фразы как эмоциональную паузу
               - Не бойся ритмических провалов: они делают текст живым

            7. **ПУНКТУАЦИЯ:**
               - Замени чрезмерно формальные конструкции на разговорные
               - Убери вводные слова, если они не обязательны
               - Предпочитай асимметрию и живость
               - Избегай пунктуационной "безупречности" — допускается лёгкая небрежность

            ### КОНКРЕТНЫЕ ДЕЙСТВИЯ:

            - Удали прилагательные, которые не добавляют значения или повторяют очевидное
            - Замени 2–3 сложных предложения на короткие и простые
            - Добавь 1–2 естественные "небрежности" в диалогах
            - Упрости описания, которые звучат слишком нарочито красиво
            - Удали очевидные и ненужные детали (например, "он посмотрел на руку, потом на дверь")
            ...
            - Если стиль уже соответствует художественной задаче — не упрощай его механически
            - Не снижай выразительность, если она работает на образ или эмоцию

...
- **"Скромняга"** - попытка обойти NSFW эротические фильтры, две версии

Итоговый скрипт: https://github.com/SDSmirnov/BookwAIre-Engineering/blob/main/enhanced_novel_generator.py
